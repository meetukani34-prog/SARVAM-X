          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-900/[0.08] dark:border-white/[0.08] bg-white/40 dark:bg-black/40 shadow-[0_0_100px_rgba(0,0,0,0.8)] backdrop-blur-xl animate-in fade-in zoom-in-95 duration-300">
            ...
            <div className="p-8 md:p-10 relative z-10">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white tracking-wide">{activeModal}</h2>
              ...
              <div className="text-slate-900/60 dark:text-white/60 space-y-5 max-h-[50vh] overflow-y-auto pr-4 text-sm md:text-base leading-relaxed font-light custom-scrollbar">
                ...
                <p>
                  Viewing documentation for: <strong className="text-slate-900 dark:text-white font-medium">{activeModal}</strong>.
                </p>
                <p>
                  {currentContent?.desc}
                </p>
