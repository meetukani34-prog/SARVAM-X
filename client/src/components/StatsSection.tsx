        ...
        {stats.map((stat, i) => {
          ...
          return (
            <div
              key={i}
              ref={ref}
              className="group relative flex flex-col items-center text-center p-6 md:p-8 rounded-2xl border border-slate-900/ dark:border-white/ bg-slate-900/[0.02] dark:bg-white/[0.02] hover:bg-white/[0.04] hover:border-slate-900/ dark:border-white/ transition-all duration-500"
            >
              {/* Icon */}
