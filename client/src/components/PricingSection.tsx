...
const PricingSection: React.FC<PricingSectionProps> = ({ onNavigate }) => {
  return (
    <section className="relative w-full py-32 overflow-hidden z-10 bg-[#07090e]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {/* Starter Plan */}
          <div className="relative group rounded-3xl border border-white/10 bg-[#0b0e14]/50 backdrop-blur-xl p-8 hover:border-white/20 transition-all duration-300 flex flex-col">
            ...
            <button 
              ...
              className="w-full py-4 rounded-xl border border-white/10 hover:border-white/30 text-white font-bold tracking-wide hover:bg-white/[0.02] transition-colors"
            >
              Start for Free
            </button>
          </div>
          ...
          {/* Professional Plan */}
          <div className="relative group rounded-3xl border border-primary/40 bg-gradient-to-b from-[#0b0e14] to-[#0b0e14]/50 backdrop-blur-xl p-8 shadow-[0_0_40px_rgba(34,197,94,0.1)] hover:shadow-[0_0_60px_rgba(34,197,94,0.2)] transition-all duration-300 flex flex-col transform md:-translate-y-4">
          ...
          <div className="relative group rounded-3xl border border-white/10 bg-[#0b0e14]/50 backdrop-blur-xl p-8 hover:border-white/20 transition-all duration-300 flex flex-col">
            ...
            <button 
              onClick={() => onNavigate("auth")}
              className="w-full py-4 rounded-xl border border-white/10 hover:border-purple/50 text-white font-bold tracking-wide hover:bg-purple/10 transition-colors"
            >
              Contact Sales
            </button>
          </div>
