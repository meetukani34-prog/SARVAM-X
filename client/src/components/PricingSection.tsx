        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="relative group rounded-3xl border border-slate-900/10 dark:border-slate-900/10 dark:border-white/10 bg-white/50 dark:bg-[#0b0e14]/50 backdrop-blur-xl p-8 hover:border-slate-900/20 dark:hover:border-slate-900/20 dark:border-white/20 transition-all duration-300 flex flex-col">
            ...
            <button 
              ...
              className="w-full py-4 rounded-xl border border-slate-900/10 dark:border-slate-900/10 dark:border-white/10 hover:border-slate-900/30 dark:hover:border-slate-900/30 dark:border-white/30 text-slate-900 dark:text-white font-bold tracking-wide hover:bg-slate-900/5 dark:hover:bg-slate-900/[0.02] dark:bg-white/[0.02] transition-colors"
            >
              Start for Free
            </button>
          </div>
          ...
          <div className="relative group rounded-3xl border border-primary/40 bg-gradient-to-b from-white dark:from-[#0b0e14] to-slate-900/50 dark:to-white/50 dark:to-[#0b0e14]/50 backdrop-blur-xl p-8 shadow-[0_0_40px_rgba(34,197,94,0.1)] hover:shadow-[0_0_60px_rgba(34,197,94,0.2)] transition-all duration-300 flex flex-col transform md:-translate-y-4">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-center gap-3 text-slate-900/90 dark:text-white/90 text-sm">
